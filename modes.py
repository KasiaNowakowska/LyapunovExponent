...
Usage: lyapunov.py [--input_path=<input_path> --output_path=<output_path> --index_mode=<index_mode> --part_to_run=<part_to_run>]

Options:
    --input_path=<input_path>          file path to use for data
    --output_path=<output_path>        file path to save images output [default: ./images]
    --index_mode=<index_mode>          mode to run lyapunov time code on
    --part_to_run=<part_to_run>        part of script to run
"""
...
part_to_run = int(args['--part_to_run'])
print('running part', part_to_run, 'in script')

#### Load Data ####
no_modes = 128
modes = np.load(input_path+'/Ra2e8_c128_data_reduced.npy')
...
modes_to_plot = np.array([1, 2, 10, 50, 64, 128]) - 1
